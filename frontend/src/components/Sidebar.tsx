  ...
  return (
    <div className="w-20 h-screen bg-beige flex-shrink-0 flex flex-col items-center pl-4">
      <div className="w-full py-5 flex justify-center">
        <div className="h-[54px] w-[61px] rounded-lg bg-orange-600 flex items-center justify-center">
      ...
      <nav className="flex flex-col items-center pt-8 space-y-8 w-full">
        <Link
          ...
          className={`flex justify-center items-center h-[40px] w-[54px] rounded-lg  transition-all ${
            isActive("/dashboard")
              ...
              : "text-gray-400 hover:bg-orange-600 hover:text-white bg-[#B3B3B1]"
          }`}
        >
        ...
        <Link
          ...
          className={`flex justify-center items-center h-[40px] w-[54px] rounded-lg transition-all ${
            isActive("/reviews")
              ? "bg-orange-500 text-white"
              : "text-gray-400 hover:bg-orange-600 bg-[#B3B3B1]  hover:text-white"
          }`}
        >
