...
const Footer: React.FC = () => {
  return (
    <footer className="w-full py-8 px-4 md:px-8 bg-gradient-to-b from-white to-slate-50 text-gray-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <img
              src="/logowtext.png"
              alt="Logo"
              className="w-[150px] h-[30px] object-contain mb-4"
            />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#analytics" className="text-gray-600 hover:text-gray-900 transition">Analytics</a></li>
              <li><a href="#insights" className="text-gray-600 hover:text-gray-900 transition">AI Insights</a></li>
              <li><a href="#tagging" className="text-gray-600 hover:text-gray-900 transition">Smart Tagging</a></li>
              <li><a href="#trends" className="text-gray-600 hover:text-gray-900 transition">Topic Trends</a></li>
              <li><a href="#pricing" className="text-gray-600 hover:text-gray-900 transition">Pricing</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-gray-900 transition">GDPR</a></li>
            </ul>
          </div>
        </div>
